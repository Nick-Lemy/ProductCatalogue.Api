...
namespace ProductCatalogue.Api.Migrations
{
    ...
    [Migration("20260617125616_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductCatalogue.Api.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ProductCatalogue.Api.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProductCatalogue.Api.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductCatalogue.Api.Models.RefreshToken", b =>
                {
                    b.HasOne("ProductCatalogue.Api.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
